...
public class AtmServiceTest {
    ...
    public void subtractBankNumberCorrectly(){
        ...
        int[] result = atmService.subtractBankAmt(balanceBanks, usedBanks);
    ...
    public void calculateTotalBalanceCorrectly(){
        ...
        int result = atmService.calCurrentTotalAmt(remainingBanks, bankValues);
    ...
    public void findBanksCorrectly(){
        ...
        List<int[]> result = atmService.findBanks(180, currentBankAmt, balanceBankAmt, bankValues, 0);
    ...
    public void calculateBankWorkCorrectlyWhenSuccess(){
        ...
        ResponseEntity<ResponseWrapper> response = atmService.calculateBank(180);
    ...
    public void calculateBankWorkCorrectlyWhenFail(){
        ...
        ResponseEntity<ResponseWrapper> response = atmService.calculateBank(10);
